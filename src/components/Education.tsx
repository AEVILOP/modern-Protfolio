    ...
    <section className="relative z-20 bg-[#0a0a0a] py-24 px-6 md:px-12 border-t border-white/5">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-medium tracking-tight text-white/90 mb-16 text-center">
        ...
        <div className="w-full relative pl-8 md:pl-0">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6 }}
            className="p-8 md:p-10 rounded-[2rem] bg-gradient-to-br from-[#18181b] to-[#121212] border border-white/5 hover:from-[#1a1a2e] hover:to-[#2d1b3d] hover:border-fuchsia-500/50 hover:shadow-[0_0_40px_rgba(217,70,239,0.15)] transition-all duration-500 w-full group"
          >
